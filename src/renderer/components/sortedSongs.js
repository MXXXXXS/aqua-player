  ...
  constructor(
    ...
    const tagSwitcher = (tag) => {
      switch (tag) {
        case 'A到Z':
          {
            sortedSongsTemplate.inStore.states.sortedData =
              shared.sortedData.songsByAZ
          }
          break
        case '歌手':
          {
            sortedSongsTemplate.inStore.states.sortedData =
              shared.sortedData.songsBySingers
          }
          break
        case '专辑':
          {
            sortedSongsTemplate.inStore.states.sortedData =
              shared.sortedData.songsByAlbums
          }
          break
      }
      ...
      sortedSongsTemplate.inStore.states.themeColor =
        storeStates.states.themeColor
    }
