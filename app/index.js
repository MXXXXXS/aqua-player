...
const AQUAAdd = require(`./components/add.js`)
const AQUAPlayList = require(`./components/playList.js`)
const AQUARecentPlayed = require(`./components/recentPlayed.js`)
const AQUAPlayLists = require(`./components/collectedPlayLists.js`)
const AQUASingleSongList = require(`./components/singleSongList.js`)
...
customElements.define(`aqua-single-song-list`, AQUASingleSongList)
